...
@section('content')
    <div class="col-md-10 text-center ml-auto mr-auto">
        <h3 class="mb-5">Introduce tu correo y contraseña.</h3>
    </div>
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('login') }}">
            ...
            <div class="card card-login card-white">
                ...
                <div class="card-body">
                    <p class="text-dark mb-2">Ingresa con <strong>Tu correo ejemplo@</strong> y tu contraseña <strong>secreta</strong></p>
