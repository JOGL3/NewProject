<nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
    <div class="container-fluid">
        <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#">{{ $page ?? __('GESTIÓN DOCUMENTARIA') }}</a>
        </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="dropdown nav-item">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right dropdown-navbar">
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('AGREGAR LOS MODULOS') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('CREAR TABLAS BD') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('ENLAZAR BD CON LARAVEL') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('GENERAR PDF') }}</a>
                        </li>
                        <li class="nav-link">
                            <a href="#" class="nav-item dropdown-item">{{ __('SUBIR INFORMACION') }}</a>
                        </li>
                    </ul>
                </li>
                <li class="dropdown nav-item">
